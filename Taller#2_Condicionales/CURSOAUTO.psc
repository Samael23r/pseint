Proceso CURSOAUTO
	...
	mientras control = Verdadero Hacer
		...
		si aprobar = 1 Entonces
			Escribir 'El aprendiz ',nombre,' aprobo el curso de enseñanza automovilistica ',aprobar,incremento;
			leer control;
		FinSi
		escribir '';
		si aprobar = 2 Entonces
			Escribir 'El aprendiz ',nombre,' Reprobo el curso de enseñanza automovilistica ',incremento;
		FinSi
